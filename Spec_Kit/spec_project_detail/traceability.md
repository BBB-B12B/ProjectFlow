...
| **[F-004]** | การติดตามเวลา (Time Tracking) | [T-031], [T-064], [T-065], [T-029], [T-085], [T-087], [T-183], [T-104], [T-106], [T-184] | `src/lib/types.ts`, `src/app/tracking/tracking-client.tsx` | **Beta** |
...
| **[F-010]** | ระบบวิเคราะห์ข้อมูล (Analytics Dashboard) | [T-022], [T-101], [T-102], [T-103], [T-185] | `src/app/analytics/*` (uses **Lite SDK**), `src/components/charts/filtered-tasks-table.tsx`, `src/components/analytics/daily-report-table.tsx` | **Active** (Features: Sorting, Global Filters (Project/Status/Assignee/Date), Metric Cards, Personalized Columns, Split Columns, Daily Report Analysis) |
