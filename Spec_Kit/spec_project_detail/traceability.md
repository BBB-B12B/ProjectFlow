...
| **[F-003]** | การจัดการงาน (Task Management) | [T-013], [T-014], [T-061], [T-063] | `src/app/project/[id]/page.tsx` (uses **Lite SDK**), `src/components/charts/*`, `src/components/strict-mode-droppable.tsx` | **Beta** |
...
| **[F-005]** | มุมมองปฏิทิน (Calendar View) | [T-020], [T-021], [T-064], [T-066], [T-029] | `src/app/calendar/page.tsx`, `src/app/calendar/calendar-client-page.tsx`, `src/app/calendar/data-fetcher.ts` (uses **Lite SDK**), `src/app/calendar/new-event-dialog.tsx` (uses **Client SDK**) | **Active** |
...
| **[F-009]** | การปรับปรุงประสิทธิภาพและลดค่าใช้จ่าย (Performance Optimization) | [T-070], [T-071], [T-072], [T-073], [T-074], [T-084] | `src/app/customers/customer-list-client.tsx`, `src/app/tracking/tracking-client.tsx`, `src/lib/firebase.ts`, `src/lib/firebase-lite.ts`, `src/components/session-timeout.tsx` | **Active** |
...
| **[F-012]** | การนำขึ้นระบบ (Deployment) | [T-090] | `package.json`, `Cloudflare Pages`, `deploy_prod.sh` | **Planned** |
| **[F-013]** | ระบบเอกสารสัญญา (Legal Agreements) | [T-091], [T-092] | `src/components/application-form.tsx`, `src/components/legal-agreement.tsx` | **Active** |
